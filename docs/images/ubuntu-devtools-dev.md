# XFCE work desktop with VS Code (Microsoft APT repo, fingerprint pinned) and the dev-ssh toolchain (git, build-essential, python3, jq, tmux, ...). No autostart: VS Code sits in the XFCE menu.

Image `ubuntu-devtools-dev` — layer `apps`, OS `ubuntu-24.04`, version `1.2.0`.
